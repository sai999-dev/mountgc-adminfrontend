      ...
      >
        ...
        <div className="p-4 border-t border-green-700">
          <button
            ...
            className="w-full flex items-center space-x-3 px-4 py-3 rounded-lg bg-red-500 text-red-100 border border-red-400 hover:bg-red-600 hover:text-white hover:border-red-600  duration-200"
          >
            <LogOut size={20} />
